...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pTankMesh->LoadMesh("C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\phoenix_ugv.md2")) {
            return false;
        }

        m_pSkyBox = new SkyBox(m_pGameCamera, m_persProjInfo);

        if (!m_pSkyBox->Init("C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content",
            "sp3right.jpg",
            "sp3left.jpg",
            "sp3top.jpg",
            "sp3bot.jpg",
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Chelyshkina Tutorial 25")) {
        return 1;
    }
