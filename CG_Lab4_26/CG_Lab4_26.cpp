...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\box.obj")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\normal_map.jpg");

        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\normal_up.jpg");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Chelyshkina Tutorial 26")) {
        return 1;
    }
