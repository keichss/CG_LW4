...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\test.png");
        ...
        return m_pMesh->LoadMesh("C:\\Users\\ASUS\\source\\repos\\CG_Lab4\\Content\\phoenix_ugv.md2");
    }
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Chelyshkina")) {
        return 1;
    }
